...
const string strMessageMagic = "Cerium Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Cerium", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "06 Jun 2015 - New York City man robbed at gunpoint for ... bitcoin?";
        CTransaction txNew;
        txNew.nTime = 1433545722;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1433545722;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3484585;
       ...
       if (true && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("0xe55946671f37213c60dc36c7d463e4c6fe5f6c178b7e1ffa50df599ea13f496d"));
